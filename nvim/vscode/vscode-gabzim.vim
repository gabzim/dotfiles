...
nnoremap <silent> <leader>fo :<C-u>call VSCodeNotify('workbench.action.quickOpen')<CR>
nnoremap <silent> <leader>ff :<C-u>call VSCodeNotify('workbench.action.findInFiles')<CR>
